...
Route::middleware('auth')->group(function() {
    ...
    ====================================================================== */
    // view表示：勤怠管理ページ
    Route::get('/attendance', [AttendanceController::class, 'createAttendance'])->middleware('owner');
    ...
    // view表示：勤怠一覧ページ
    Route::get('/attendance/list/', [AttendanceController::class, 'indexAttendance'])->middleware('owner');

    // view表示：時間外一覧ページ
    Route::get('/attendance/over', [AttendanceController::class, 'indexOverAttendance'])->middleware('owner');

    /* ======================================================================
    休暇申請
    ====================================================================== */
    // view表示：休暇申請ページ
    Route::get('/holiday', [HolidayController::class, 'createHoliday'])->middleware('owner');
    ...
    ====================================================================== */
    // view表示：日報報告ページ
    Route::get('/report', [ReportController::class, 'createReport'])->middleware('owner');
    ...
    // メール通知処理
    Route::post('/mail', [MailController::class, 'storeMail']); 
});